let dbSession,deducirMensajeError;_872‍.x([["resumenEncomiendasBus",()=>resumenEncomiendasBus],["listadoEncomiendasViaje",()=>listadoEncomiendasViaje],["encomiendasAlCobro",()=>encomiendasAlCobro]]);_872‍.w("../../../pool",[["default",["dbSession"],function(v){dbSession=v}]]);_872‍.w("../../../utils",[["deducirMensajeError",["deducirMensajeError"],function(v){deducirMensajeError=v}]]);


       const resumenEncomiendasBus = async (req, res) => {            
...
const configurarVistaResumenEncomiendasBus = (rows) => {
    ...
    return viajes;
       ...
       const listadoEncomiendasViaje = async (req, res) => {        
...
const configurarVistaListadoEncomiendasViaje = (rows) => {
    ...
    return listados;
       ...
       const encomiendasAlCobro = async (req, res) => {    
    const disco = parseInt(req.params.disco);
