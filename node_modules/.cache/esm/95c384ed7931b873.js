let dbSession,deducirMensajeError;_793‍.x([["resumenCreditos",()=>resumenCreditos],["detalleCredito",()=>detalleCredito],["resumenAportaciones",()=>resumenAportaciones]]);_793‍.w("../../../pool",[["default",["dbSession"],function(v){dbSession=v}]]);_793‍.w("../../../utils",[["deducirMensajeError",["deducirMensajeError"],function(v){deducirMensajeError=v}]]);
    ...
    try{
       ...
       const detalleCredito = async (req, res) => {        
    ...
    try{
       ...
       const resumenAportaciones = async (req, res) => {            
    const ruc = req.params.ruc;
    const { codigo_empresa } = req.headers;            
    const pool = dbSession(codigo_empresa);     
