let dbSession,deducirMensajeError;_ec8‍.x([["resumenViajesBus",()=>resumenViajesBus],["listadoPasajerosViaje",()=>listadoPasajerosViaje],["boletosDeRetorno",()=>boletosDeRetorno]]);_ec8‍.w("../../../pool",[["default",["dbSession"],function(v){dbSession=v}]]);_ec8‍.w("../../../utils",[["deducirMensajeError",["deducirMensajeError"],function(v){deducirMensajeError=v}]]);


       const resumenViajesBus = async (req, res) => {            
...
const configurarVistaResumenViajesBus = (rows) => {
    ...
    return viajes;
       ...
       const listadoPasajerosViaje = async (req, res) => {        
...
const configurarVistaListadoPasajerosViaje = (rows) => {
    ...
    return listados;
       ...
       const boletosDeRetorno = async (req, res) => {    
    const disco = parseInt(req.params.disco);
